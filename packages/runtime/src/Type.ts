...
// 			?? (this.kind === TypeKind.Object && this.name == "Object" && (!description.props || !description.props.length) // TODO: Review kind == Object
// 					? undefined
// 					: Type.Object
// 			);
// 	}
...
// 			|| this.kind == TypeKind.StringLiteral // TODO: Review if Literals should be here
// 			|| this.kind == TypeKind.TemplateLiteral
// 			|| this.kind == TypeKind.NumberLiteral
// 			|| this.kind == TypeKind.EnumLiteral
// 			|| this.kind == TypeKind.BigIntLiteral
// 			|| this.kind == TypeKind.BooleanLiteral
