...
export class Type
{
	public static readonly Any: Type = new Type({ id: Symbol(), name: "any", kind: TypeKind.Any, module: NID });
	public static readonly Unknown: Type = new Type({ id: Symbol(), name: "unknown", kind: TypeKind.Unknown, module: NID });
	public static readonly Void: Type = new Type({ id: Symbol(), name: "void", kind: TypeKind.Void, module: NID });
	public static readonly Never: Type = new Type({ id: Symbol(), name: "never", kind: TypeKind.Never, module: NID });
	public static readonly Null: Type = new Type({ id: Symbol(), name: "null", kind: TypeKind.Null, module: NID });
	public static readonly Undefined: Type = new Type({ id: Symbol(), name: "undefined", kind: TypeKind.Undefined, module: NID });
	public static readonly Object: Type = new Type({ id: Symbol(), name: "Object", kind: TypeKind.Object, module: NID });
	public static readonly String: Type = new Type({ id: Symbol(), name: "String", kind: TypeKind.String, module: NID });
	public static readonly Number: Type = new Type({ id: Symbol(), name: "Number", kind: TypeKind.Number, module: NID });
	public static readonly BigInt: Type = new Type({ id: Symbol(), name: "BigInt", kind: TypeKind.BigInt, module: NID });
	public static readonly Boolean: Type = new Type({ id: Symbol(), name: "Boolean", kind: TypeKind.Boolean, module: NID });
	public static readonly Date: Type = new Type({ id: Symbol(), name: "Date", kind: TypeKind.Date, module: NID });
	public static readonly Symbol: Type = new Type({ id: Symbol(), name: "Symbol", kind: TypeKind.Symbol, module: NID });
	public static readonly RegExp: Type = new Type({ id: Symbol(), name: "RegExp", kind: TypeKind.RegExp, module: NID });
	public static readonly Int8Array: Type = new Type({ id: Symbol(), name: "Int8Array", kind: TypeKind.Int8Array, module: NID });
	public static readonly Uint8Array: Type = new Type({ id: Symbol(), name: "Uint8Array", kind: TypeKind.Uint8Array, module: NID });
	public static readonly Uint8ClampedArray: Type = new Type({ id: Symbol(), name: "Uint8ClampedArray", kind: TypeKind.Uint8ClampedArray, module: NID });
	public static readonly Int16Array: Type = new Type({ id: Symbol(), name: "Int16Array", kind: TypeKind.Int16Array, module: NID });
	public static readonly Uint16Array: Type = new Type({ id: Symbol(), name: "Uint16Array", kind: TypeKind.Uint16Array, module: NID });
	public static readonly Int32Array: Type = new Type({ id: Symbol(), name: "Int32Array", kind: TypeKind.Int32Array, module: NID });
	public static readonly Uint32Array: Type = new Type({ id: Symbol(), name: "Uint32Array", kind: TypeKind.Uint32Array, module: NID });
	public static readonly Float32Array: Type = new Type({ id: Symbol(), name: "Float32Array", kind: TypeKind.Float32Array, module: NID });
	public static readonly Float64Array: Type = new Type({ id: Symbol(), name: "Float64Array", kind: TypeKind.Float64Array, module: NID });
	public static readonly BigInt64Array: Type = new Type({ id: Symbol(), name: "BigInt64Array", kind: TypeKind.BigInt64Array, module: NID });
	public static readonly BigUint64Array: Type = new Type({ id: Symbol(), name: "BigUint64Array", kind: TypeKind.BigUint64Array, module: NID });
	...
	private readonly _id: TypeReference;
	...
	private readonly _moduleReference: ModuleReference;
